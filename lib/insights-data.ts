...
export const INSIGHT_TOPICS: Record<string, InsightTopic> = {
  'most-affordable-first-home-markets': {
    ...
    description: 'Cities where a median-income household can realistically buy — price-to-income under 6× and home prices under $200K. Updated monthly.',
    ...
    methodNote: 'We use Numbeo 2026 crowdsourced averages for apartment prices and net income. "Years of income" = price ÷ median household income. Cities with fewer than 20 Numbeo data points are excluded from the source data.',
  ...
  'biggest-price-drops-this-year': {
    ...
    description: 'Cities where home prices are falling year-over-year. Ranked by 1-year price change. Updated monthly from Numbeo.',
    ...
    methodNote: '1-year price change from Numbeo crowdsourced listings, measured in local currency (not USD) to avoid exchange-rate noise. Cities with YoY decline > 0% are included and ranked by magnitude of drop.',
    query: queryDrops,
  },
  'rent-vs-buy-renting-wins': {
    ...
    description: 'Markets with price-to-rent ratios above 25 — where the math favors renting unless you stay 10+ years. Updated monthly.',
    ...
    methodNote: 'Price-to-rent = average apartment price ÷ (1-bedroom monthly rent × 12). All rents are Numbeo averages for city-center 1BR apartments. Cities with unavailable rent data are excluded.',
    query: queryRentWins,
  },
  'luxury-markets-under-pressure': {
    ...
    description: 'High-priced cities (average home > $500K) where appreciation has stalled or reversed. Updated monthly.',
    ...
    methodNote: 'We include cities where average home price exceeds $500K and 1-year appreciation is below 2% (effectively flat after inflation). Prices from Numbeo 2026 crowdsourced listings.',
  ...
  'emerging-affordable-cities-to-watch': {
    ...
    description: 'Cities under $250K average home price with strong 1-year appreciation (3%+) and 500K+ population. Updated monthly.',
